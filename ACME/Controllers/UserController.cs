...
namespace ACME.Controllers
{
    ...
    public class UserController : BaseApiController
    {
        ...
        public IHttpActionResult GetAllusers()
        {
            ...
            var Users = objbasecontroller.ConertToListof<User_Property>(_objUserBLL.GetAllUsers());
        ...
        public IHttpActionResult VerifyUser(LoginProperty objlogin)
        {
            ...
            objbasecontroller = new BaseController();
            var Users = objbasecontroller.ConertToListof<User_Property>(_objUserBLL.GetUserByIDPass());
            // bagService.GetAllBags();
            var response = new ResponseClass() { Status = true, ResponseObject = Users };
            return Ok(response);
        }
